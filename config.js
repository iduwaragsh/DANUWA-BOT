...
const defaultConfig = {
  ...
  ALIVE_MSG: "*Hello👋 d.s.p*", // Change alive msg from here
  OPENAI_API_KEY: "",// Add OPENAI API key here
  GEMINI_API_KEY: "HIBRmZTI#06g8uzTWgionWhBsPo2hiNPH6D2zOLklyXF9WtQLy4E", // Add Gemini API key here
  ...
  ownerNumber: ["94783187572"], // Replace your bot owner number here (same as bot owner number)
